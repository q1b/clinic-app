	...
	<div class="storybook-header">
		...
		<div>
			{#if user}
				...
				<Button size="sm" on:click={onLogout}>Log Out</Button>
			{:else}
				<Button size="sm" on:click={onLogin}>Log In</Button>
				<Button variant="secondary" size="sm" on:click={onCreateAccount}>Sign Up</Button>
			{/if}
		</div>
	</div>
</header>
