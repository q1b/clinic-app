<script lang="ts">
	import '../app.postcss';
	import { HomeIcon, LogOutIcon, PlusIcon } from 'lucide-svelte';
	...
	let value: any;
	let loadingTimeslotAction: boolean = false;
</script>
...
<button
	class="flex items-center pl-2 pr-3.5 py-1 border border-slate-400 hover:bg-slate-100 cursor-pointer active:bg-slate-200/80 transition-colors absolute bottom-10 right-6 text-xl gap-x-2 z-10 bg-slate-50/20 backdrop-blur-sm"
